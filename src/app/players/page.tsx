...
export default function () {
  ...
  const config: TableConfig<Player> = {
    columns: [
      ...
      {
        name: "Team",
        column: "current_roster.roster.team.name",
        alignment: ColumnAlignment.Left,
        sortable: true,
      },
      {
        name: "Position",
        column: "current_roster.position",
        alignment: ColumnAlignment.Left,
        sortable: true,
      },
      {
        name: "Height",
        column: "current_roster.height",
        alignment: ColumnAlignment.Left,
        sortable: true,
      },
      {
        name: "Age",
        column: "current_roster.age",
        alignment: ColumnAlignment.Left,
        sortable: true,
      },
    ],
    searchFn: (request) =>
      fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL!}/players/search`, {
        method: "POST",
        ...
        [
          {
            ...
            comparator: { operator: ComparatorOperator.IsSet, value: null },
          },
        ],
      ],
    },
